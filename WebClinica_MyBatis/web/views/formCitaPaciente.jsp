...
<html>
    <head>
        ...
        <title>Formulario de Cita de Paciente</title>
    </head>
    <body>
        <div class="container"  >
            <form class="form-horizontal" method = "POST" action="/WebClinica_MyBatis/controller?action=createDoctor" name="frmCitaPaciente" id="frmDoctor">
                <div class="form-group">
                    <div class="col-sm-7" style="text-align: center;">
                        <h2>Formulario de Cita de Paciente</h2>
                    </div>
                </div>
                <div class="form-group">	
            ...
            <div class="form-group col-sm-6"  style="text-align: center;">
                <button class="btn btn-primary" type="submit" form="frmCitaPaciente">Crear Cita de Paciente</button>
            </div>
        </div>
    </body>
